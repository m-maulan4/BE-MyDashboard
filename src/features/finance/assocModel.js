...
kategoriModel.hasMany(transaksiModel, { foreignKey: "id_kategori" });
transaksiModel.belongsTo(kategoriModel, { foreignKey: "id_kategori" });
dompetModal.hasMany(transaksiModel, { foreignKey: "id_dompet" });
transaksiModel.belongsTo(dompetModal, { foreignKey: "id_dompet" });

export { dompetModal, transaksiModel };
